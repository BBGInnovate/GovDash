...
function HomeCtrl($scope, APIData, APIQueryData) {
	...
	/*
		...
		$scope.youtubeInteractions = data.barChartData[0].d;


		$scope.totalInteractionsChange = parseInt(Math.random() * 9);
		$scope.facebookInteractionsChange = parseInt(Math.random() * 9);
		$scope.twitterInteractionsChange = parseInt(Math.random() * 9);
		$scope.youtubeInteractionsChange = parseInt(Math.random() * 9);

		// bar chart data
		$scope.barChartData = data.barChartData;

		// spark chart data
		$scope.chartData = data.chartOne;
		$scope.chartData2 = data.chartTwo;
		$scope.chartData3 = data.chartThree;
