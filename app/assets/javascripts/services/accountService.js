angular.module('accountService', [])
    .factory('Accounts', function($location, $http, $q, $rootScope) {
        ...
        var account = {
            ...
            create: function(name, description, object_name, socialMediaAccount, organizationId, groupId, subgroupIds, languageId, regionIds, countryIds, accountTypeId, segmentIds) {
                return $http.post('/api/accounts', {account: {name: name, description: description, object_name: object_name, media_type_name: socialMediaAccount, organization_id: organizationId, group_id: groupId, subgroup_ids: subgroupIds, language_id: languageId, region_ids: regionIds, country_ids: countryIds, account_type_id: accountTypeId, sc_segment_ids: segmentIds } })
            ...
            update: function(accountId, name, description, object_name, socialMediaAccount, organizationId, groupId, subgroupIds, languageId, regionIds, countryIds, accountTypeId, segmentIds) {
